...
Fill out link:.github/ISSUE_TEMPLATE/bug_report.md[the required template], the information it asks for helps us to resolve issues faster.
...
Bugs are tracked as Issues. Provide the following information by filling in link:.github/ISSUE_TEMPLATE/bug_report.md[the template].
